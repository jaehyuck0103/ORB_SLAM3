...
bool LoopClosing::DetectAndReffineSim3FromLastKF(
    ...
    if (nNumProjMatches >= nProjMatches) {
        ...
        // Verbose::PrintMess("Sim3 reffine: There are " + to_string(numOptMatches) + " matches
    ...
    // We need to propagate the correction through the spanning tree
    {
        ...
        if (!mbStopGBA) {
            ...
            while (!lpKFtoCheck.empty()) {
                ...
                " << pKF->GetCovisiblesByWeight(80).size() << " connected KF with 80 common matches
                or more" << endl; cout << "--It has " << pKF->GetCovisiblesByWeight(50).size() << "
                connected KF with 50 common matches or more" << endl; cout << "--It has " <<
                pKF->GetCovisiblesByWeight(20).size() << " connected KF with 20 common matches or
                more" << endl;
